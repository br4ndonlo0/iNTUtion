      ...
      <main className="max-w-6xl mx-auto px-4 py-8 space-y-6">
        ...
        >
          ...
          <div className="flex gap-3">
            <input
              className="flex-1 rounded-lg border border-slate-200 bg-white py-3 px-3 text-slate-900 outline-none focus:ring-2 focus:ring-blue-200 placeholder:text-slate-400"
